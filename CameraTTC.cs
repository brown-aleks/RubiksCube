...
namespace Common.CameraTTC
{
    // Самая обычная камера взятая из учебника. немного урезанная на то, чтобы всегда смотрела на пересечение координат.
    public class CameraTTC  // to the center
    {
        ...
        private Vector3 _position = new(1f, 1f, -1f);    // - Vector3.UnitZ;
